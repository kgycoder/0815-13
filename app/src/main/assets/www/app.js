...
function updateVolTrack(v) {
    ...
    const thumb = document.getElementById('np-vol-thumb');
    const glow = document.getElementById('np-vol-glow');
...
(function initVolTrack() {
    ...
    // frame so the fill/thumb/glow always match the finger 1:1.
    let dragging = false;
